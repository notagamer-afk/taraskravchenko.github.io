...
**Live site:** [https://taraskravchenko.github.io/](https://taraskravchenko.github.io/)

**PDF:** open any page over **HTTP(S)**, then click **DOWNLOAD CV**. The browser pulls the same HTML fragments, renders them with [html2canvas](https://html2canvas.hertzen.com/), and saves `CV_Taras_Kravchenko_YYYY-MM-DD.pdf` via [jsPDF](https://github.com/parallax/jsPDF).
